...
DROP TYPE resultados_m;
DROP TYPE resultados_p;

CREATE  TYPE resultados_m as (nombre_materia text,codigo text, promedio double precision);
...
CREATE OR REPLACE FUNCTION existe_predicado(text)
RETURNS integer AS
$$
BEGIN
